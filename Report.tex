...
\begin{equation}
    D = \frac{V_{\mathrm{out}}}{V_{\mathrm{in}}} \cdot \frac{N_1}{N_2} = \frac{14}{48} \cdot \frac{32}{28} \approx 0.36
...
\end{equation}
\section{3b}
This question looks at the control of a high-side MOSFET within a dual-switch forward converter configuration and how it is possible to use a bootstrap and high-voltage level-shifting MOSFET circuit to drive the high-side MOSFET, \cite{BootstrapCircuit}.
