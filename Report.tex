...
\section{1a}
For this question a thermal circuit was to be sketched to represent the system. The thermal circuit is shown in Figure~\ref{fig:question1a}.
\begin{figure}[h]
    \centering
    \includegraphics[width=0.25\textwidth]{./Images/Q1Ai.png}
