...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
        & Power Dissipation W\(_{IGBT}\) & 12 W \\
        IGBT& Junction to case thermal resistance R\(_{\theta j c}\)& \(0.6 ^\circ C/W\)\\
        &Case to heatsink thermal resistance R\(_{\theta c h s}\)& \(1.4 ^\circ C/W\)\\
        \hline
        &Power Dissipation W\(_{Diode}\) & 7 W\\
        Diode & Junction to case thermal resistance R\(_{\theta j c}\)& \(0.9^\circ C/W\)\\
        &Case to heatsink thermal resistance R\(_{\theta c h s}\)& \(1.5 ^\circ C/W\)\\
        \hline
        &Heatsink to ambient thermal resistance R\(_{\theta h s a}\)& \(3.2 ^\circ C/W\) \\
        Heatsink& Thermal capacitance \(C_{\theta hs}\)& 280 \(J/^\circ C\)\\
        &Ambient Temperature & 40 $^\circ$C \\
        \hline
    \end{tabular}
\end{table}
